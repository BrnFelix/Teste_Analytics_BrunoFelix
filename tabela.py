...
vendas_por_prato = df_limpo.groupby('Prato')['Total_Vendas'].sum().sort_values(ascending=False)
...
print(tabela.to_string(index=False, formatters={'Total de Vendas (R$)': 'R$ {:,.2f}'.format}))

print(f"\n O prato mais lucrativo do resturante: {prato_top} com R$ {valor_top:,.2f} em vendas.")
